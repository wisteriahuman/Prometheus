...
<div class="mx-auto max-w-2xl py-4">
  ...
  <div class="mt-6 rounded-xl border border-border bg-bg-card p-5">
    ...
    <div class="space-y-2 text-xs text-text-muted leading-relaxed">
      <p>ノートは <code class="rounded bg-bg-dark px-1.5 py-0.5 font-mono text-accent">{data.vaultPath}</code> に <code class="rounded bg-bg-dark px-1.5 py-0.5 font-mono text-accent">.md</code> ファイルとして保存されます。</p>
